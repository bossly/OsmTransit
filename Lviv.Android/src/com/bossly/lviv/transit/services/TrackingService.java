...
public class TrackingService extends Service implements LocationListener
{
  ...
  private void showTrackingNotification()
  {
    ...
    Notification notification = new Notification( R.drawable.ic_stat_updates, text, System.currentTimeMillis() );
  ...
  private void showNotification( Intent intent )
  {
    ...
    // Set the info for the views that show in the
    // notification panel.
    notification.setLatestEventInfo( this, getString( R.string.srv_warning_exit_msg ), text, contentIntent );
